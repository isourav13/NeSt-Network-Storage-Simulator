...
../src/network/utils/broadcom-drop-tail-queue.cc \
../src/network/utils/broadcom-egress-queue.cc \
../src/network/utils/broadcom-queue.cc \
...
./src/network/utils/broadcom-drop-tail-queue.d \
./src/network/utils/broadcom-egress-queue.d \
./src/network/utils/broadcom-queue.d \
...
./src/network/utils/broadcom-drop-tail-queue.o \
./src/network/utils/broadcom-egress-queue.o \
./src/network/utils/broadcom-queue.o \
...
src/network/utils/%.o: ../src/network/utils/%.cc src/network/utils/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-network-2f-utils

clean-src-2f-network-2f-utils:
	-$(RM) ./src/network/utils/address-utils.d ./src/network/utils/address-utils.o ./src/network/utils/broadcom-drop-tail-queue.d ./src/network/utils/broadcom-drop-tail-queue.o ./src/network/utils/broadcom-egress-queue.d ./src/network/utils/broadcom-egress-queue.o ./src/network/utils/broadcom-queue.d ./src/network/utils/broadcom-queue.o ./src/network/utils/crc32.d ./src/network/utils/crc32.o ./src/network/utils/data-rate.d ./src/network/utils/data-rate.o ./src/network/utils/drop-tail-queue.d ./src/network/utils/drop-tail-queue.o ./src/network/utils/dynamic-queue-limits.d ./src/network/utils/dynamic-queue-limits.o ./src/network/utils/error-channel.d ./src/network/utils/error-channel.o ./src/network/utils/error-model.d ./src/network/utils/error-model.o ./src/network/utils/ethernet-header.d ./src/network/utils/ethernet-header.o ./src/network/utils/ethernet-trailer.d ./src/network/utils/ethernet-trailer.o ./src/network/utils/flow-id-tag.d ./src/network/utils/flow-id-tag.o ./src/network/utils/inet-socket-address.d ./src/network/utils/inet-socket-address.o ./src/network/utils/inet6-socket-address.d ./src/network/utils/inet6-socket-address.o ./src/network/utils/ipv4-address.d ./src/network/utils/ipv4-address.o ./src/network/utils/ipv6-address.d ./src/network/utils/ipv6-address.o ./src/network/utils/llc-snap-header.d ./src/network/utils/llc-snap-header.o ./src/network/utils/mac16-address.d ./src/network/utils/mac16-address.o ./src/network/utils/mac48-address.d ./src/network/utils/mac48-address.o ./src/network/utils/mac64-address.d ./src/network/utils/mac64-address.o ./src/network/utils/mac8-address.d ./src/network/utils/mac8-address.o ./src/network/utils/net-device-queue-interface.d ./src/network/utils/net-device-queue-interface.o ./src/network/utils/output-stream-wrapper.d ./src/network/utils/output-stream-wrapper.o ./src/network/utils/packet-burst.d ./src/network/utils/packet-burst.o ./src/network/utils/packet-data-calculators.d ./src/network/utils/packet-data-calculators.o ./src/network/utils/packet-probe.d ./src/network/utils/packet-probe.o ./src/network/utils/packet-socket-address.d ./src/network/utils/packet-socket-address.o ./src/network/utils/packet-socket-client.d ./src/network/utils/packet-socket-client.o ./src/network/utils/packet-socket-factory.d ./src/network/utils/packet-socket-factory.o ./src/network/utils/packet-socket-server.d ./src/network/utils/packet-socket-server.o ./src/network/utils/packet-socket.d ./src/network/utils/packet-socket.o ./src/network/utils/packetbb.d ./src/network/utils/packetbb.o ./src/network/utils/pcap-file-wrapper.d ./src/network/utils/pcap-file-wrapper.o ./src/network/utils/pcap-file.d ./src/network/utils/pcap-file.o ./src/network/utils/queue-item.d ./src/network/utils/queue-item.o ./src/network/utils/queue-limits.d ./src/network/utils/queue-limits.o ./src/network/utils/queue-size.d ./src/network/utils/queue-size.o ./src/network/utils/queue.d ./src/network/utils/queue.o ./src/network/utils/radiotap-header.d ./src/network/utils/radiotap-header.o ./src/network/utils/simple-channel.d ./src/network/utils/simple-channel.o ./src/network/utils/simple-net-device.d ./src/network/utils/simple-net-device.o ./src/network/utils/sll-header.d ./src/network/utils/sll-header.o

.PHONY: clean-src-2f-network-2f-utils
