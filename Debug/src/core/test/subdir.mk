...
CC_DEPS += \
./src/core/test/attribute-container-test-suite.d \
...
./src/core/test/pair-value-test-suite.d \
...
OBJS += \
./src/core/test/attribute-container-test-suite.o \
...
./src/core/test/pair-value-test-suite.o \
...
src/core/test/%.o: ../src/core/test/%.cc src/core/test/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-core-2f-test

clean-src-2f-core-2f-test:
	-$(RM) ./src/core/test/attribute-container-test-suite.d ./src/core/test/attribute-container-test-suite.o ./src/core/test/attribute-test-suite.d ./src/core/test/attribute-test-suite.o ./src/core/test/build-profile-test-suite.d ./src/core/test/build-profile-test-suite.o ./src/core/test/callback-test-suite.d ./src/core/test/callback-test-suite.o ./src/core/test/command-line-test-suite.d ./src/core/test/command-line-test-suite.o ./src/core/test/config-test-suite.d ./src/core/test/config-test-suite.o ./src/core/test/event-garbage-collector-test-suite.d ./src/core/test/event-garbage-collector-test-suite.o ./src/core/test/examples-as-tests-test-suite.d ./src/core/test/examples-as-tests-test-suite.o ./src/core/test/global-value-test-suite.d ./src/core/test/global-value-test-suite.o ./src/core/test/hash-test-suite.d ./src/core/test/hash-test-suite.o ./src/core/test/int64x64-test-suite.d ./src/core/test/int64x64-test-suite.o ./src/core/test/length-test-suite.d ./src/core/test/length-test-suite.o ./src/core/test/many-uniform-random-variables-one-get-value-call-test-suite.d ./src/core/test/many-uniform-random-variables-one-get-value-call-test-suite.o ./src/core/test/names-test-suite.d ./src/core/test/names-test-suite.o ./src/core/test/object-test-suite.d ./src/core/test/object-test-suite.o ./src/core/test/one-uniform-random-variable-many-get-value-calls-test-suite.d ./src/core/test/one-uniform-random-variable-many-get-value-calls-test-suite.o ./src/core/test/pair-value-test-suite.d ./src/core/test/pair-value-test-suite.o ./src/core/test/ptr-test-suite.d ./src/core/test/ptr-test-suite.o ./src/core/test/random-variable-stream-test-suite.d ./src/core/test/random-variable-stream-test-suite.o ./src/core/test/rng-test-suite.d ./src/core/test/rng-test-suite.o ./src/core/test/sample-test-suite.d ./src/core/test/sample-test-suite.o ./src/core/test/simulator-test-suite.d ./src/core/test/simulator-test-suite.o ./src/core/test/threaded-test-suite.d ./src/core/test/threaded-test-suite.o ./src/core/test/time-test-suite.d ./src/core/test/time-test-suite.o ./src/core/test/timer-test-suite.d ./src/core/test/timer-test-suite.o ./src/core/test/traced-callback-test-suite.d ./src/core/test/traced-callback-test-suite.o ./src/core/test/type-id-test-suite.d ./src/core/test/type-id-test-suite.o ./src/core/test/type-traits-test-suite.d ./src/core/test/type-traits-test-suite.o ./src/core/test/watchdog-test-suite.d ./src/core/test/watchdog-test-suite.o

.PHONY: clean-src-2f-core-2f-test
