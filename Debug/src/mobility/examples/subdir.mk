...
clean-src-2f-mobility-2f-examples:
	-$(RM) ./src/mobility/examples/bonnmotion-ns2-example.d ./src/mobility/examples/bonnmotion-ns2-example.o ./src/mobility/examples/main-grid-topology.d ./src/mobility/examples/main-grid-topology.o ./src/mobility/examples/main-random-topology.d ./src/mobility/examples/main-random-topology.o ./src/mobility/examples/main-random-walk.d ./src/mobility/examples/main-random-walk.o ./src/mobility/examples/mobility-trace-example.d ./src/mobility/examples/mobility-trace-example.o ./src/mobility/examples/ns2-mobility-trace.d ./src/mobility/examples/ns2-mobility-trace.o
