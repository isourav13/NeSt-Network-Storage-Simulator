...
src/wave/model/%.o: ../src/wave/model/%.cc src/wave/model/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-wave-2f-model

clean-src-2f-wave-2f-model:
	-$(RM) ./src/wave/model/bsm-application.d ./src/wave/model/bsm-application.o ./src/wave/model/channel-coordinator.d ./src/wave/model/channel-coordinator.o ./src/wave/model/channel-manager.d ./src/wave/model/channel-manager.o ./src/wave/model/channel-scheduler.d ./src/wave/model/channel-scheduler.o ./src/wave/model/default-channel-scheduler.d ./src/wave/model/default-channel-scheduler.o ./src/wave/model/higher-tx-tag.d ./src/wave/model/higher-tx-tag.o ./src/wave/model/ocb-wifi-mac.d ./src/wave/model/ocb-wifi-mac.o ./src/wave/model/vendor-specific-action.d ./src/wave/model/vendor-specific-action.o ./src/wave/model/vsa-manager.d ./src/wave/model/vsa-manager.o ./src/wave/model/wave-mac-low.d ./src/wave/model/wave-mac-low.o ./src/wave/model/wave-net-device.d ./src/wave/model/wave-net-device.o

.PHONY: clean-src-2f-wave-2f-model
