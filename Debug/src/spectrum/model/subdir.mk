...
./src/spectrum/model/matrix-based-channel-model.d \
...
./src/spectrum/model/three-gpp-channel-model.d \
./src/spectrum/model/three-gpp-spectrum-propagation-loss-model.d \
./src/spectrum/model/trace-fading-loss-model.d \
...
./src/spectrum/model/matrix-based-channel-model.o \
...
./src/spectrum/model/three-gpp-channel-model.o \
./src/spectrum/model/three-gpp-spectrum-propagation-loss-model.o \
./src/spectrum/model/trace-fading-loss-model.o \
...
src/spectrum/model/%.o: ../src/spectrum/model/%.cc src/spectrum/model/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-spectrum-2f-model

clean-src-2f-spectrum-2f-model:
	-$(RM) ./src/spectrum/model/aloha-noack-mac-header.d ./src/spectrum/model/aloha-noack-mac-header.o ./src/spectrum/model/aloha-noack-net-device.d ./src/spectrum/model/aloha-noack-net-device.o ./src/spectrum/model/constant-spectrum-propagation-loss.d ./src/spectrum/model/constant-spectrum-propagation-loss.o ./src/spectrum/model/friis-spectrum-propagation-loss.d ./src/spectrum/model/friis-spectrum-propagation-loss.o ./src/spectrum/model/half-duplex-ideal-phy-signal-parameters.d ./src/spectrum/model/half-duplex-ideal-phy-signal-parameters.o ./src/spectrum/model/half-duplex-ideal-phy.d ./src/spectrum/model/half-duplex-ideal-phy.o ./src/spectrum/model/matrix-based-channel-model.d ./src/spectrum/model/matrix-based-channel-model.o ./src/spectrum/model/microwave-oven-spectrum-value-helper.d ./src/spectrum/model/microwave-oven-spectrum-value-helper.o ./src/spectrum/model/multi-model-spectrum-channel.d ./src/spectrum/model/multi-model-spectrum-channel.o ./src/spectrum/model/non-communicating-net-device.d ./src/spectrum/model/non-communicating-net-device.o ./src/spectrum/model/single-model-spectrum-channel.d ./src/spectrum/model/single-model-spectrum-channel.o ./src/spectrum/model/spectrum-analyzer.d ./src/spectrum/model/spectrum-analyzer.o ./src/spectrum/model/spectrum-channel.d ./src/spectrum/model/spectrum-channel.o ./src/spectrum/model/spectrum-converter.d ./src/spectrum/model/spectrum-converter.o ./src/spectrum/model/spectrum-error-model.d ./src/spectrum/model/spectrum-error-model.o ./src/spectrum/model/spectrum-interference.d ./src/spectrum/model/spectrum-interference.o ./src/spectrum/model/spectrum-model-300kHz-300GHz-log.d ./src/spectrum/model/spectrum-model-300kHz-300GHz-log.o ./src/spectrum/model/spectrum-model-ism2400MHz-res1MHz.d ./src/spectrum/model/spectrum-model-ism2400MHz-res1MHz.o ./src/spectrum/model/spectrum-model.d ./src/spectrum/model/spectrum-model.o ./src/spectrum/model/spectrum-phy.d ./src/spectrum/model/spectrum-phy.o ./src/spectrum/model/spectrum-propagation-loss-model.d ./src/spectrum/model/spectrum-propagation-loss-model.o ./src/spectrum/model/spectrum-signal-parameters.d ./src/spectrum/model/spectrum-signal-parameters.o ./src/spectrum/model/spectrum-value.d ./src/spectrum/model/spectrum-value.o ./src/spectrum/model/three-gpp-channel-model.d ./src/spectrum/model/three-gpp-channel-model.o ./src/spectrum/model/three-gpp-spectrum-propagation-loss-model.d ./src/spectrum/model/three-gpp-spectrum-propagation-loss-model.o ./src/spectrum/model/trace-fading-loss-model.d ./src/spectrum/model/trace-fading-loss-model.o ./src/spectrum/model/tv-spectrum-transmitter.d ./src/spectrum/model/tv-spectrum-transmitter.o ./src/spectrum/model/waveform-generator.d ./src/spectrum/model/waveform-generator.o ./src/spectrum/model/wifi-spectrum-value-helper.d ./src/spectrum/model/wifi-spectrum-value-helper.o

.PHONY: clean-src-2f-spectrum-2f-model
