...
clean-examples-2f-tcp:
	-$(RM) ./examples/tcp/dctcp-example.d ./examples/tcp/dctcp-example.o ./examples/tcp/star.d ./examples/tcp/star.o ./examples/tcp/tcp-bulk-send.d ./examples/tcp/tcp-bulk-send.o ./examples/tcp/tcp-large-transfer.d ./examples/tcp/tcp-large-transfer.o ./examples/tcp/tcp-linux-reno.d ./examples/tcp/tcp-linux-reno.o ./examples/tcp/tcp-nsc-comparison.d ./examples/tcp/tcp-nsc-comparison.o ./examples/tcp/tcp-nsc-lfn.d ./examples/tcp/tcp-nsc-lfn.o ./examples/tcp/tcp-nsc-zoo.d ./examples/tcp/tcp-nsc-zoo.o ./examples/tcp/tcp-pacing.d ./examples/tcp/tcp-pacing.o ./examples/tcp/tcp-pcap-nanosec-example.d ./examples/tcp/tcp-pcap-nanosec-example.o ./examples/tcp/tcp-star-server.d ./examples/tcp/tcp-star-server.o ./examples/tcp/tcp-validation.d ./examples/tcp/tcp-validation.o ./examples/tcp/tcp-variants-comparison.d ./examples/tcp/tcp-variants-comparison.o
