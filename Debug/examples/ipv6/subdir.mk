...
examples/ipv6/%.o: ../examples/ipv6/%.cc examples/ipv6/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-examples-2f-ipv6

clean-examples-2f-ipv6:
	-$(RM) ./examples/ipv6/fragmentation-ipv6-two-MTU.d ./examples/ipv6/fragmentation-ipv6-two-MTU.o ./examples/ipv6/fragmentation-ipv6.d ./examples/ipv6/fragmentation-ipv6.o ./examples/ipv6/icmpv6-redirect.d ./examples/ipv6/icmpv6-redirect.o ./examples/ipv6/loose-routing-ipv6.d ./examples/ipv6/loose-routing-ipv6.o ./examples/ipv6/ping6.d ./examples/ipv6/ping6.o ./examples/ipv6/radvd-two-prefix.d ./examples/ipv6/radvd-two-prefix.o ./examples/ipv6/radvd.d ./examples/ipv6/radvd.o ./examples/ipv6/test-ipv6.d ./examples/ipv6/test-ipv6.o ./examples/ipv6/wsn-ping6.d ./examples/ipv6/wsn-ping6.o

.PHONY: clean-examples-2f-ipv6
