...
#define NVME_UPDATE_SQ_TAIL(Q)  Q.Submission_queue_tail++;\
	...
	public:
		...
		virtual void Get_statistics(Utils::Workload_Statistics& stats, LPA_type(*Convert_host_logical_address_to_device_address)(int id, LHA_type lha),
					page_status_type(*Find_NVM_subunit_access_bitmap)(int id, LHA_type lha)) = 0;
	...
	protected:
		...
		std::unordered_map<sim_time_type,SimInterfaceRequest*> response_tracker; //track response using arrival time
