...
namespace SSD_Components
{
	...
	public:
		...
		typedef void(*UserRequestServicedSignalHanderType) (User_Request*, int);
		void Connect_to_user_request_serviced_signal(UserRequestServicedSignalHanderType);
		typedef void(*MemoryTransactionServicedSignalHanderType) (NVM_Transaction*, int);
	...
	protected:
		...
		static void handle_user_request_arrived_signal(User_Request* user_request, int id);
