...
namespace MQSimEngine
{
	...
	{
	public:
		Sim_Event(int device_id, sim_time_type fireTime, Sim_Object* targetObject, void* parameters = NULL, int type = 0)
			: device_id(device_id), Fire_time(fireTime), Target_sim_object(targetObject), Parameters(parameters), Type(type), Next_event(NULL), Ignore(false) {}
