...
namespace SSD_Components
{
	...
	public:
		...
		typedef void(*TransactionServicedHandlerType) (NVM_Transaction_Flash*, int);
		void ConnectToTransactionServicedSignal(TransactionServicedHandlerType);
		typedef void(*ChannelIdleHandlerType) (flash_channel_ID_type, int);
		void ConnectToChannelIdleSignal(ChannelIdleHandlerType);
		typedef void(*ChipIdleHandlerType) (NVM::FlashMemory::Flash_Chip*, int);
