...
namespace MQSimEngine {
	...
	public:
		...
		std::queue<SimInterfaceRequest*> queued_requests[HOSTS];
		std::deque<SimInterfaceRequest*> queued_response[HOSTS];



		static Engine** Instance();
		sim_time_type Time();
		Sim_Event* Register_sim_event(int device_id, sim_time_type fireTime, Sim_Object* targetObject, void* parameters = NULL, int type = 0);
		...
		static void invoke_event(Sim_Event* ev);
