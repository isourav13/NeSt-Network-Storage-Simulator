...
namespace ns3
{
	enum class Flow_Type { SYNTHETIC, TRACE, NS3 };
	...
	public:
        ...
        class IO_Flow_Parameter_Set_NS3_Based : public IO_Flow_Parameter_Set
        {
        public:
                IO_Flow_Parameter_Set_NS3_Based() { this->Type = Flow_Type::NS3; }
                //std::string File_Path;
                int Percentage_To_Be_Executed;
                int Relay_Count;
                Trace_Time_Unit Time_Unit;
