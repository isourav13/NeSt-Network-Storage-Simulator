	...
	* its own share of CMT (equal partitioning of CMT space among concurrent streams).*/
	...
	public:
		...
		* proposal. It is always stored in non-volatile flash memory.*/
		...
		void Update_mapping_info(int device_no, const bool ideal_mapping, const stream_id_type stream_id, const LPA_type lpa, const PPA_type ppa, const page_status_type page_status_bitmap);
	...
	private:
		...
		static void handle_transaction_serviced_signal_from_PHY(NVM_Transaction_Flash* transaction, int d);
