...
{
	NVM_Transaction_Flash_RD::NVM_Transaction_Flash_RD(int device_id, Transaction_Source_Type source, stream_id_type stream_id,
		...
		NVM_Transaction_Flash(device_id, source, Transaction_Type::READ, stream_id, data_size_in_byte, lpa, ppa, related_user_IO_request, IO_Flow_Priority_Class::UNDEFINED),
	...
	NVM_Transaction_Flash_RD::NVM_Transaction_Flash_RD(int device_id, Transaction_Source_Type source, stream_id_type stream_id,
		...
		NVM::memory_content_type content, NVM_Transaction_Flash_WR* related_write, page_status_type read_sectors_bitmap, data_timestamp_type data_timestamp) :
		NVM_Transaction_Flash(device_id, source, Transaction_Type::READ, stream_id, data_size_in_byte, lpa, ppa, address, related_user_IO_request, IO_Flow_Priority_Class::UNDEFINED),
		Content(content), RelatedWrite(related_write), read_sectors_bitmap(read_sectors_bitmap), DataTimeStamp(data_timestamp)
	{
         transc_device_id = device_id;
	}
	...
	NVM_Transaction_Flash_RD::NVM_Transaction_Flash_RD(int device_id, Transaction_Source_Type source, stream_id_type stream_id,
		...
		NVM_Transaction_Flash(device_id, source, Transaction_Type::READ, stream_id, data_size_in_byte, lpa, ppa, related_user_IO_request, priority_class),
