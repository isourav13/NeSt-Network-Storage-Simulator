...
{
	NVM_Transaction_Flash_WR::NVM_Transaction_Flash_WR(int device_id, Transaction_Source_Type source, stream_id_type stream_id,
		...
		NVM_Transaction_Flash(device_id, source, Transaction_Type::WRITE, stream_id, data_size_in_byte, lpa, ppa, address, user_io_request, IO_Flow_Priority_Class::UNDEFINED),
	...
	NVM_Transaction_Flash_WR::NVM_Transaction_Flash_WR(int device_id, Transaction_Source_Type source, stream_id_type stream_id,
		...
		NVM_Transaction_Flash(device_id, source, Transaction_Type::WRITE, stream_id, data_size_in_byte, lpa, ppa, user_io_request, IO_Flow_Priority_Class::UNDEFINED),
		Content(content), RelatedRead(related_read), write_sectors_bitmap(written_sectors_bitmap), DataTimeStamp(data_timestamp),
		ExecutionMode(WriteExecutionModeType::SIMPLE)
	{
         transc_device_id = device_id;
	...
	NVM_Transaction_Flash_WR::NVM_Transaction_Flash_WR(int device_id, Transaction_Source_Type source, stream_id_type stream_id,
		...
		NVM_Transaction_Flash(device_id, source, Transaction_Type::WRITE, stream_id, data_size_in_byte, lpa, NO_PPA, user_io_request, priority_class),
	...
	NVM_Transaction_Flash_WR::NVM_Transaction_Flash_WR(int device_id, Transaction_Source_Type source, stream_id_type stream_id,
		...
		page_status_type written_sectors_bitmap, data_timestamp_type data_timestamp) :
		NVM_Transaction_Flash(device_id, source, Transaction_Type::WRITE, stream_id, data_size_in_byte, lpa, NO_PPA, user_io_request, IO_Flow_Priority_Class::UNDEFINED),
		Content(content), RelatedRead(NULL), write_sectors_bitmap(written_sectors_bitmap), DataTimeStamp(data_timestamp),
		ExecutionMode(WriteExecutionModeType::SIMPLE)
	{
        transc_device_id = device_id;
